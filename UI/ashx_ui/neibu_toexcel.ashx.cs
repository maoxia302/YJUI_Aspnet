...
namespace YJUI.UI.ashx_ui
{
    ...
    public class neibu_toexcel : IHttpHandler
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            sb.Append("select ID,convert(char(10),fkDate,120) as 反馈时间 ,fkPerson as 反馈人 ,fkDep as 反馈部门 ,wtDep as 问题部门," +
            ...
            string cs = "序号,反馈时间,反馈人,反馈部门,问题部门,问题部门,反馈描述," +
            ...
            //rowhead.CreateCell(3, CellType.String).SetCellValue("反馈部门");
            //rowhead.CreateCell(4, CellType.String).SetCellValue("问题部门");
            //rowhead.CreateCell(5, CellType.String).SetCellValue("反馈描述");
            //rowhead.CreateCell(6, CellType.String).SetCellValue("领取部门");
            //rowhead.CreateCell(7, CellType.String).SetCellValue("领取人");
