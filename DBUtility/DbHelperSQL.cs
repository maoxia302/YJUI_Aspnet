...
namespace YJUI.DBUtility
{
    ...
    public abstract class DbHelperSQL
    {
        ...
        /// <returns></returns>
        public static int GetMaxCode(string FieldName, string TableName, string strWhere)
        {
        ...
        /// <returns></returns>
        public static int ExcuteCommandReturnInt(string CommandText, CommandType type,params SqlParameter[] pars)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                connection.Open();
        ...
        public static void ExecuteStoredProcedure(string p, SqlParameter[] parameters, out int row)
        {
